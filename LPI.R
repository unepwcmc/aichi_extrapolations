...
TestSignalToNoise("Global_LPI",log_transform = F,arcsin_sqrt_transform = T)
...
#m[[13]] <- FitAutocorrelatedModel("chaprichfun", "(a,b,d,year)", 3, "eafs", "list(a = 2, b = -0.1,d = -0.1)", "list(a = 1, b = 0.1,d = 5)", "coef(m2)", TRUE,  num_data_points = num_data_points, ylabel, "Chapman-Richards")
...
#---------------------------------------------------------------------------------------
# MODEL 15: POWER-LAW 
m[[15]] <- FitAutocorrelatedModel("powerfun", "(a,b,year)", 2, "eafs", "list(a = 20, b = 1)", "coef(m1)", "coef(m2)", fitAR2 = TRUE, TRUE,  num_data_points = num_data_points, ylabel, "Power")
