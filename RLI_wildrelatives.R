...
inputdata<-read.csv("rli_wildrelatives.csv")
DLM_Signal_To_Noise_Wrapper(inputdata,do_log_transform = FALSE,do_asin_transform = TRUE)
# File name for the input file
Filename = "rli_wildrelatives"
...
ylabel = "Index value (birds, mammals, amphibians)"
maintitle = "Red List Index showing trends for wild relatives of farmed and domestic spp"
...
writepdfsandresults(output_directory_images, output_directory_files, output_name,0.76)
