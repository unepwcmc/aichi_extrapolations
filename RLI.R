...
data_directory = "C:/Users/samanthah/Documents/Aichi Extrapolations/Final_data/SDG/"
...
TestSignalToNoise("RLI",log_transform = FALSE,arcsin_sqrt_transform = TRUE)
...
m[[1]] <- FitAutocorrelatedModel("poly1fun", "(a,b,year)", 3, "eafs", "list(a =142, b = -0.07)", "coef(m1)", "coef(m1)", TRUE, fitAR1 = TRUE, fitAR2 = TRUE, num_data_points = num_data_points, ylabel, "First order polynomial")
...
m[[13]] <- FitAutocorrelatedModel("chaprichfun", "(a,b,d,year)", 3, "eafs", "list(a = 2, b = -0.1,d = -0.1)", "list(a = 1.1, b = 0.1,d = 5)", "coef(m1)", "coef(m2)", TRUE,  num_data_points = num_data_points, ylabel, "Chapman-Richards")
...
writepdfsandresults(output_directory_images, output_directory_files, output_name, 0.5)
