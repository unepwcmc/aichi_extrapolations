...
data_directory = "C:/Users/derekt/desktop/temp2/"
output_directory_images = "C:/Users/derekt/desktop/temp2/"
output_directory_files = "C:/Users/derekt/desktop/temp2/"

TestSignalToNoise("Proportion_fish_stocks_safe_biological_limits",log_transform = FALSE,arcsin_sqrt_transform = TRUE)
# File name for the input file
Filename = "Proportion_fish_stocks_safe_biological_limits"
...
ylabel = "Percent"
maintitle = "Fish stocks within safe biological limits"
...
m[[2]] <- FitAutocorrelatedModel("ratk423", "(a,b,year)", 2, "eafs", "list(a = 20, b = 0.1)", "coef(m1)", "coef(m1)", TRUE, fitAR1 = FALSE, num_data_points = num_data_points, ylabel, "2 parameter negative exponential")
...
#---------------------------------------------------------------------------------------
# MODEL 15: POWER-LAW 
m[[15]] <- FitAutocorrelatedModel("powerfun", "(a,b,year)", 2, "eafs", "list(a = 20, b = 1)", "coef(m1)", "coef(m2)",  fitAR1 = FALSE, TRUE,  num_data_points = num_data_points, ylabel, "Power")
