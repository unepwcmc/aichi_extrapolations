...
TestSignalToNoise("Biodiversity_barometer_ready",log_transform = FALSE,arcsin_sqrt_transform = TRUE)
# File name for the input file
Filename = "Biodiversity_barometer_ready"
