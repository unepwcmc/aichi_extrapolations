...
DLM_Signal_To_Noise_Wrapper("RLI_tradedspp.csv",do_log_transform = FALSE,do_asin_transform = TRUE)
# File name for the input file
Filename = "RLI_tradedspp"
...
maintitle = "Red List Index showing trends for internationally traded species"
...
writepdfsandresults(output_directory_images, output_directory_files, output_name,0.92)
