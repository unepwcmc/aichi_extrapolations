...
TestSignalToNoise("marinetrophicindex",log_transform = FALSE,arcsin_sqrt_transform = FALSE)
# File name for the input file
Filename = "marinetrophicindex2"
...
ylabel = "Index value"
maintitle = "Marine trophic index"
...
#--------------------------------------------------------------------------------------
# MODEL 4: HYPERBOLIC
m[[4]] <- FitAutocorrelatedModel("hyperfun", "(a,b,year)", 2, "eafs", "list(a = 200, b = -1)", "coef(m1)", "coef(m2)", TRUE,fitAR1 = TRUE,fitAR2 = TRUE,num_data_points = num_data_points, ylabel, "Hyperbolic")
...
m[[7]] <- FitAutocorrelatedModel("hivfun", "(a,b,c,year)", 3, "eafs", "list(a = 1.1, b = 1, c = 1)", "coef(m1)", "coef(m2)", TRUE, fitAR1 = FALSE, fitAR2 = FALSE, num_data_points = num_data_points, ylabel, "Hollings Type IV")
...
writepdfsandresults(output_directory_images, output_directory_files, output_name, 3.2)
