...
TestSignalToNoise("PA_terrestrial",log_transform = FALSE,arcsin_sqrt_transform = FALSE)
# File name for the input file
Filename = "PA_terrestrial"
...
ylabel = "Land area (km2)"
maintitle = "Terrestrial protected area coverage"
