...
TestSignalToNoise("ODAbiodiv",log_transform = FALSE,arcsin_sqrt_transform = FALSE)
...
ylabel = "Millions of 2014 USD"
maintitle = "Total biodiversity-related bilateral ODA"
