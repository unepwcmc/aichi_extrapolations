...
TestSignalToNoise("RLI_IAS",log_transform = FALSE,arcsin_sqrt_transform = TRUE)
...
maintitle = "Red List Index showing trends driven by invasive alien species"
...
m[[1]] <- FitAutocorrelatedModel("poly1fun", "(a,b,year)", 2, "eafs", "list(a =142, b = -0.07)", "coef(m1)", "coef(m2)", TRUE, fitAR1 = TRUE, fitAR2 = FALSE, num_data_points = num_data_points, ylabel, "First order polynomial")
...
writepdfsandresults(output_directory_images, output_directory_files, output_name, 0.83)
