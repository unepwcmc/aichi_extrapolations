...
TestSignalToNoise("RLI_pollutn",log_transform = FALSE,arcsin_sqrt_transform = FALSE)
# File name for the input file
Filename = "RLI_pollutn"
...
writepdfsandresults(output_directory_images, output_directory_files, output_name, 0.838)
