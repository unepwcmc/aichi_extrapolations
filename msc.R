...
TestSignalToNoise("MSC_Certified_Catch_GBO5",log_transform = FALSE,arcsin_sqrt_transform = FALSE)
# File name for the input file
Filename = "MSC_Certified_Catch_GBO5"
...
ylabel = "Tonnage of certified fisheries"
maintitle = "MSC certified fisheries"
