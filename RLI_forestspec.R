...
maintitle = "Red List Index showing trends for forest specialists"
...
writepdfsandresults(output_directory_images, output_directory_files, output_name,0.7)
