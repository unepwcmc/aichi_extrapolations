...
TestSignalToNoise("PA_KBA_global",log_transform = FALSE,arcsin_sqrt_transform = TRUE)
# File name for the input file
Filename = "PA_KBA_global_short"
...
maintitle = "Protected area coverage of KBAs"
...
m[[3]] <- FitAutocorrelatedModel("ratk4333", "(a,b,c,year)", 3, "eafs", "list(a = 30, b = 1, c = -0.5)", "coef(m1)", "coef(m2)",  TRUE, fitAR1 = TRUE,fitAR2 = FALSE,num_data_points = num_data_points, ylabel, "3 parameter negative exponential")
