...
setwd("C:/Users/samanthah/Documents/Aichi Extrapolations/Final_data/")
data_directory = "C:/Users/samanthah/Documents/Aichi Extrapolations/Final_data/"
output_directory_images = "C:/Users/samanthah/Documents/Aichi Extrapolations/Final_data/"
output_directory_files = "C:/Users/samanthah/Documents/Aichi Extrapolations/Final_data/"
inputdata<-read.csv("mangrovebiome_ext.csv")
#inputdata$data<-inputdata$data/1000
DLM_Signal_To_Noise_Wrapper(inputdata,do_log_transform = FALSE,do_asin_transform = FALSE)
# File name for the input file
Filename = "mangrovebiome_ext"
...
ylabel = "square kilometres"
maintitle = "Area of forest within mangrove biome"
...
output_name = "Mangrovebiomeforext"
...
m[[2]] <- FitAutocorrelatedModel("ratk423", "(a,b,year)", 2, "eafs", "list(a = 20, b = 0.1)", "coef(m1)", "coef(m1)", TRUE, fitAR1 = TRUE,fitAR2 = TRUE, num_data_points = num_data_points, ylabel, "2 parameter negative exponential")
...
#--------------------------------------------------------------------------------------
# MODEL 4: HYPERBOLIC
m[[4]] <- FitAutocorrelatedModel("hyperfun", "(a,b,year)", 2, "eafs", "list(a = 200, b = -1)", "coef(m1)", "coef(m2)", TRUE,fitAR1 = FALSE,nocor_nlsTol = 5,  num_data_points = num_data_points, ylabel, "Hyperbolic")
...
m[[6]] <- FitAutocorrelatedModel("hiiifun", "(a,b,year)", 2, "eafs", "list(a = 1.1, b = 1)", "coef(m1)", "coef(m2)", TRUE,fitAR1 = TRUE,fitAR2 = TRUE, num_data_points = num_data_points, ylabel, "Hollings Type III")
...
#--------------------------------------------------------------------------------------
# MODEL 8: RATIONAL
m[[8]] <- FitAutocorrelatedModel("rationalfun", "(a,b,d,year)", 3, "eafs", "list(a = 1.1, b = 1, d = 1)", "coef(m1)", "list(a = 1.1, b = 0.03, d = 1)", TRUE,fitAR1 = TRUE,  num_data_points = num_data_points, ylabel, "Rational")
...
writepdfsandresults(output_directory_images, output_directory_files, output_name, 155000)
