...
TestSignalToNoise("plantgeneticres",log_transform = FALSE,arcsin_sqrt_transform = FALSE)
# File name for the input file
Filename = "plantgeneticres"
...
ylabel = "Number of accessions"
maintitle = "Plant genetic resources secured in conservation facilities under medium or long term conditions"
...
m[[3]] <- FitAutocorrelatedModel("ratk4333", "(a,b,c,year)", 3, "eafs", "list(a = 30, b = 1, c = -0.5)", "coef(m1)", "list(a = 30, b = 1, c = -0.5)",  TRUE, fitAR1 = TRUE,fitAR2 = FALSE,num_data_points = num_data_points, ylabel, "3 parameter negative exponential")
...
m[[5]] <- FitAutocorrelatedModel("mmfun", "(a,b,year)", 2, "eafs", "list(a = 10, b = 1)", "coef(m1)", "coef(m2)", TRUE,fitAR2 = TRUE,  num_data_points = num_data_points, ylabel, "Michaelis-Menten",0.1)
...
#---------------------------------------------------------------------------------------
# MODEL 15: POWER-LAW 
m[[15]] <- FitAutocorrelatedModel("powerfun", "(a,b,year)", 2, "eafs", "list(a = 20, b = 1)", "coef(m1)", "coef(m2)",  fitAR1 = TRUE, FALSE,  num_data_points = num_data_points, ylabel, "Power")
