...
TestSignalToNoise("biod_bar_def_biod_ready",log_transform = FALSE,arcsin_sqrt_transform = TRUE)
# File name for the input file
Filename = "biod_bar_def_biod_ready"
...
ylabel = "Percent"
maintitle = "Biodiversity Barometer: percentage correctly defining biodiversity (excl. Brazil)"
