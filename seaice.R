...
TestSignalToNoise("snowice",log_transform = FALSE,arcsin_sqrt_transform = TRUE)
...
ylabel = "Mean extent (million sq km)"
maintitle = "Mean polar sea ice extent"
...
writepdfsandresults(output_directory_images, output_directory_files, output_name, minimum_y_limit = 22)
