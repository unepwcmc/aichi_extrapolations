...
TestSignalToNoise("ecolfoot",log_transform = FALSE,arcsin_sqrt_transform = FALSE)
...
ylabel = "Number of earths available and demanded"
maintitle = "World Ecological Footprint by Component"
