...
inputdata<-read.csv("mangrove_forest.csv")
...
ylabel = "squre kilometres"
maintitle = "Area of mangrove forest"
...
m[[3]] <- FitAutocorrelatedModel("ratk4333", "(a,b,c,year)", 3, "eafs", "list(a = 30, b = 1, c = -0.5)", "coef(m1)", "list(a = 30, b = 1, c = -0.5)",  TRUE, fitAR1 = FALSE,fitAR2 = FALSE,num_data_points = num_data_points, ylabel, "3 parameter negative exponential")
...
m[[7]] <- FitAutocorrelatedModel("hivfun", "(a,b,c,year)", 3, "eafs", "list(a = 1.1, b = 1, c = 1)", "coef(m1)", "coef(m2)", TRUE, fitAR1 = FALSE, num_data_points = num_data_points, ylabel, "Hollings Type IV")
...
writepdfsandresults(output_directory_images, output_directory_files, output_name, 80000)
