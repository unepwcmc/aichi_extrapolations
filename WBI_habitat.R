...
TestSignalToNoise("wbi_habitat",log_transform = F,arcsin_sqrt_transform = T)
# File name for the input file
Filename = "wbi_habitat"
...
#--------------------------------------------------------------------------------------
# MODEL 11: RICKER
m[[11]] <- FitAutocorrelatedModel("rickerfun", "(a,b,year)", 2, "eafs", "list(a = 1.1, b = 1)", "coef(m1)", "coef(m2)", TRUE, fitAR1 = TRUE,fitAR2 = TRUE, num_data_points = num_data_points, ylabel, "Ricker")
...
m[[13]] <- FitAutocorrelatedModel("chaprichfun", "(a,b,d,year)", 3, "eafs", "list(a = 2, b = -0.1,d = -0.1)", "list(a = 1, b = 0.1,d = 5)", "coef(m2)", TRUE, fitAR1 = TRUE, num_data_points = num_data_points, ylabel, "Chapman-Richards")
