...
TestSignalToNoise("RLI_fish2",log_transform = FALSE,arcsin_sqrt_transform = FALSE)
...
writepdfsandresults(output_directory_images, output_directory_files, output_name, 0.881)
