...
TestSignalToNoise("googletrends",log_transform = FALSE,arcsin_sqrt_transform = TRUE)
# File name for the input file
Filename = "googletrends"
...
plot(eafs$year, eafs$data, type = "l", xlab = "Year", ylab = "Mean scaled proportional search volume", main = "Google trends: biodiversity searches")

# Turn warnings off for attempting model fits
#options(warn = -1)

# THIS IS THE NAME OF THE OUTPUT FILE 
output_name = "GoogParametric"
