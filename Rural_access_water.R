...
TestSignalToNoise("Rural_access_water",log_transform = FALSE,arcsin_sqrt_transform = TRUE)
# File name for the input file
Filename = "Rural_access_water"
...
ylabel = "Percent of global rural population with access"
maintitle = "Access to improved water resources "
