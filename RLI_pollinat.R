...
TestSignalToNoise("RLI_pollinat",log_transform = FALSE,arcsin_sqrt_transform = TRUE)
# File name for the input file
Filename = "RLI_pollinat"
...
maintitle = "Red List Index showing trends for pollinating species"
...
writepdfsandresults(output_directory_images, output_directory_files, output_name,0.895)
